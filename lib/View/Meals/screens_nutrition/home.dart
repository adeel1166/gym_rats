...
class _NutritionPageState extends State<NutritionPage> {
  final foods = [
    ...
    [
      ...
      4.7,
      'A soft, crumbly cheese that originated in Greece and is typically made from sheep s milk, although it can also be made from goat s milk or a combination of both.',
      '80 kcal',
      '5 g',
      '160 mg'
    ],
